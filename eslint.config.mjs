...
export default [
  ...
  // TypeScript ESLint flat configs (sets up parser + recommended rules)
  ...tseslintPlugin.configs['flat/recommended'],

  // Jest flat recommended config
  jestPlugin.configs['flat/recommended'],

  // Disable import/no-unresolved for the ESLint config file itself (imports are resolved at runtime)
  {
  ...
  // Main configuration with custom rules and parser options
  {
    files: ['**/*.ts'],
    languageOptions: {
      parser: tsparser,
